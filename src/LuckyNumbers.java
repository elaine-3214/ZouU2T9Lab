public class LuckyNumbers
{
    ...
    public String getLuckyNumbers() {
        String list = randomIntegerBetween(0,65) + "," + randomIntegerBetween(0,65) +"," +  randomIntegerBetween(0,65) + "," + randomIntegerBetween(0,65) + "," + randomIntegerBetween(0,65)+ "," + randomIntegerBetween(0,30);
        return list;
    }
}
